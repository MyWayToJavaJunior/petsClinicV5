...
Докуменетация можно найти на ресурсе [Pets-clinic site](http://petsclinic.site40.net/docs).
Программа консольная, запуск производится посредством команды 
java -jar имяпрограммы 
