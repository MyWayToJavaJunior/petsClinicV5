...
public class IO {
    ...
    private static final String MSG_MAIN_MENU = "1 view / 2 add / 3 view by Person name /" +
            " 4 view by Pet name / 5 rem by Person name / 6 rem by Pet name /" +
            " 7 ren Person / 8 ren Pet / 9 / 0 Exit";
